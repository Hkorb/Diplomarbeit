...
\begin{figure}
	...
	\caption{$\bullet$ Velocity probes \legendThree{Turbine 0}{Turbine 1}{Turbine 2} \\ \rule[3pt]{3pt}{1pt} \rule[3pt]{3pt}{1pt} \rule[3pt]{3pt}{1pt} \rule[3pt]{3pt}{1pt} Inner domain \rule[3pt]{20pt}{1pt} Outer domain. Layout of the computational domain in the LBM-ALM environment.}
	\label{fig:domain}
\end{figure}

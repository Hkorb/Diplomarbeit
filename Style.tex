\usepackage[german,english]{babel}                          % deutsche Trennmuster
...
\newcommand{\legendOne}[1]{{\color[HTML]{1E90FF} \rule[3pt]{15pt}{1pt}} #1 }
\newcommand{\legendTwo}[2]{\legendOne{#1}{\color[HTML]{DC143C} \rule[3pt]{4pt}{1pt}\hspace{1pt}\rule[3pt]{4pt}{1pt}\hspace{1pt}\rule[3pt]{4pt}{1pt}} #2 }
\newcommand{\legendThree}[3]{\legendTwo{#1}{#2}{\color[HTML]{228B22} \rule[3pt]{5pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{5pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}} #3 }
\newcommand{\legendFour}[4]{\legendThree{#1}{#2}{#3}{\color[HTML]{000080} \rule[3pt]{3pt}{1pt}\hspace{2pt}\rule[3pt]{3pt}{1pt}\hspace{2pt}\rule[3pt]{3pt}{1pt}\hspace{2pt}} #4 }
\newcommand{\legendFive}[5]{\legendFour{#1}{#2}{#3}{#4}{\color{black} \rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}\hspace{1pt}\rule[3pt]{1pt}{1pt}} #5 }

...
\usepackage[outer=20mm,inner=30mm,bottom=40mm,headsep=10mm,footskip=12mm,head=17pt]{geometry}
...
%\usepackage{cite}
\usepackage[backend=bibtex8, style=numeric, giveninits=true, doi=false, isbn=false, eprint=false]{biblatex}
\renewbibmacro{in:}{}
\usepackage{csquotes}
%\usepackage{bibgerm}
